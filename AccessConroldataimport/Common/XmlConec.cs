   ...
   public  class XmlConec
    {
        ...
        public static string GetSQLConectionacc()
        {
            string Strconn = "";
            if (getAppSettings_("Authentic") == "false")
                Strconn = "Data Source=" + getAppSettings_("accSQLServer") + ";Initial Catalog=" + getAppSettings_("accDatabase") + ";Integrated Security=true;Pooling=false";
            else
                Strconn = "Data Source=" + getAppSettings_("accSQLServer") + ";Initial Catalog=" + getAppSettings_("accDatabase") + ";Persist Security Info=True;User ID=" + getAppSettings_("accSQLUserId") + ";Password=" + getAppSettings_("accSQLPassword");
            return Strconn;
        }
