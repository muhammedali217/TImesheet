...
//{
//    public class PushAttendenceJob : Job
//    {
//        /// <summary>
...
//            //nCounter++;
//            Console.WriteLine("FetchTodayzLogs");
//            DataTable dtValues = DBHelper.ExecuteDataset("FetchTodayzLogs").Tables[0];
//            if (dtValues.Rows.Count > 0)
//            {
//                System.Console.Clear();
//                Console.WriteLine("New Job Number " + nCounter);
...
//                //string INOUT = Convert.ToString(row["INOUT"]);
//                string strBaseUrl = XmlConec.getAppSettings_("ApiUrl");
//                string strURI = string.Format(strBaseUrl + "api/PunchDetails/AddPunchDetails?AttendanceLog_Id=" + AttendanceLogId + "&AttendanceLog_Date=" + AttendanceDate + "&AttendanceLog_InTime=" + InTime + "&AttendanceLog_PunchRecords=" + PunchRecords + "&AttendanceLog_Status=" + Status + "&Employee_Id=" + EmployeeId);
//                var varJson = new WebClient().DownloadString(strURI);
//                string strJson = varJson;
//            }
//            nCounter++;
