<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploadjobdesc.aspx.cs" Inherits="TimeSheet.uploadjobdesc" %>
...
<head>
    ...
    <title>Techvantage | Upload Job Description</title>
                                ...
                                <div class="tab-pane active" id="sidebar-tabs-menu">
                                    ...
                                    <div>
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            ...
                                            <li class="active">
                                                <a class="" href="#nav-Employee" data-toggle="collapse" aria-expanded="">
                                        ...
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            ...
                                            <li class="active">
                                                <a class="" href="#nav-Project" data-toggle="collapse" aria-expanded="">
                                                    <i class="fa fa-tasks"></i>
                                                    <span>Projects</span>
                                                </a>
                                                <ul id="nav-Project" class="collapse" aria-expanded="" style="">
                                                    <li>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">UPLOAD EMPLOYEE JOB DESCRIPTION</h2>
                                    </div>
                                    <hr />
                                    <form id="Form1" runat="server">
                                        <div>

<label style="padding-left:470px; color:red;">Upload PDF Documents Only</label>
                                            <center>
                                           ...
                                           <asp:DropDownList ID = "ddlCustomers" runat="server"></asp:DropDownList>
                                            ...
                                            <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="UploadFile"  /><br />
    ...
    <script src="pagescripts/uploadjobsdesc.js"></script>
</body>
</html>
