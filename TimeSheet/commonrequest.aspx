<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commonrequest.aspx.cs" Inherits="TimeSheet.commonrequest" %>
...
<head>
    ...
    <title>Techvantage | Common Request</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">COMMON REQUEST</h2>
                                        <hr />
                                    </div>
                                    ...
                                    <form>
                                        ...
                                        <div class="col-md-4 col-md-offset-4">
                                            ...
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1" ">Request For</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <input type="text" class="form-control" id="txtReqestFor" placeholder="Enter Request Purpose">
                                                </fieldset>
                                            </section>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-md-offset-4">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <select class="selectpicker" id="ddlRequestType" name="ddlRequestType">
                                        ...
                                        <div class="col-md-4 col-md-offset-4">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <input type="text" class="form-control" id="txtReqestDesc" placeholder="Detailed Description" style="height: 65px; width: 350px;">
                                                </fieldset>
                                            </section>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">                    
                                               <label id="lblWait" style="margin-left:90px;">Please Wait...</label>
                                           </fieldset>
                                            </section>
                                        </div>      
                                        ...
                                        <hr />
                                        <div style="padding: 15px; margin-bottom: 15px;" class="col-md-4 col-md-offset-4  text-center">
    ...
    <script src="pagescripts/commonrequest.js"></script>
