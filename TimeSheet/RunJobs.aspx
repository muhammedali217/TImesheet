<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RunJobs.aspx.cs" Inherits="TimeSheet.RunJobs" %>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">OUT OF OFFICE ATTENDANCE - UPDATE</h2>
                                    </div>
                                    <hr />
                                    <form>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-12">
                                                <!-- datepic01-->
                                                <label for="exampleInputEmail1">Date From</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                <br />
                                                <input class="form-control" style="width: 100%; height: 38px; padding: 5px;" id="txtDateFrom" name="txtDateFrom" placeholder="Choose Start Date" />
                                            </section>
                                            <section class="col-md-12">
                                                <!-- datepic01-->
                                                <label for="exampleInputEmail11">Date To</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                <br />
                                                <input class="form-control" style="width: 100%; height: 38px; padding: 5px;" id="txtDateTo" name="txtDateTo" placeholder="Choose End Date" />
                                            </section>
                                            <%--<section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <br />
                                                    <input placeholder="Select Date" class="datepicker" id="txtFromDate" oninput="this.className = ''" name="FromDate" style="width: 100%">
                                                </fieldset>
                                            </section>
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <br />
                                                    <input placeholder="Select Date" id="txtToDate" class="datepicker" oninput="this.className = ''" name="ToDate" style="width: 100%">
                                                </fieldset>
                                            </section>--%>
                                        </div>
                                        <%--================================================--%>
                                        ...
                                        <div style="padding: 15px;" class="col-md-6 col-md-offset-3  text-center">
                                            <section class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-default bt.n-lg" id="btnWeeklyAttUpdateoOffice">Udate Attendance</button>
                                            </section>
                                        </div>
                                        <span class="clearfix"></span>
                                    </form>
    ...
    <script src="pagescripts/RunJobs.js"></script>
