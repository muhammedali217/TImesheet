<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetAllocation.aspx.cs" Inherits="TimeSheet.AssetAllocation" %>
...
<body id="viewEmployee">
                                     ...
                                     <div class="col-md-6 col-md-offset-3" >
                                      ...
                                      <div style="padding:15px;" class="col-md-6 col-md-offset-3  text-center" >
                                         ...
                                         <button type="button" class="btn btn-default bt.n-lg" id="btnDeallocate">Deallocate</button>
                                              ...
                                              <button type="button" class="btn btn-default bt.n-lg" id="btnSubmit">Allocate</button> 
   ...
   <script src="pagescripts/AssetAllocation.js"></script>
