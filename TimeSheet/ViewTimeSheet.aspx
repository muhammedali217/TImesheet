<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTimeSheet.aspx.cs" Inherits="TimeSheet.ViewTimeSheet" %>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">EMPLOYEE TIMESHEET</h2>
                                    ...
                                    <form style="margin-bottom: 20px">
                                        <div class="col-md-2">
                                            <label for="exampleInputEmail1">Select Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                            <input type="text" class="form-control" id="txtDate" placeholder="Choose Date" /><br /><br />
                                            <input type="text" class="" id="txtSDate" placeholder="Start Date" style="margin-left:900px;"/> <br /><br /><input type="text" class="" id="txtEDate" placeholder="End Date"  style="margin-left:900px;"/>
                                             <button type="button" class="btn btn-default" style="margin-top: 25px; margin-bottom: 30px;margin-left:875px;" id="btnExport">Export This Week TimeSheet</button>
                                            
                                        </div>
                                        <%--<div class="col-md-3">
                                            <button type="button" class="btn btn-primary" style="margin-top: 25px; margin-bottom: 30px" id="btnSubmit">submit</button>
                                            <button type="button" class="btn btn-success" style="margin-top: 25px; margin-bottom: 30px" id="btnBack">Back</button>
                                        </div>--%>
                                    </form>
                                    <span class="clearfix"></span>

                                    <div id="tblContractor">
                                    </div>
    ...
    <script src="pagescripts/ViewTimeSheet.js"></script>
