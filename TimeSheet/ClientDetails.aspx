<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientDetails.aspx.cs" Inherits="TimeSheet.ClientDetails" %>
...
<body id="viewEmployee">
   <div class="st-container">
                                    ...
                                    <form>
                                     <div class="col-md-6 col-md-offset-3" >
                                      ...
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Client ID</label> <font color="red" size="4px"><b> * </b></font>
                                        <input type="text" class="form-control" id="txtclientId" placeholder="Enter Client ID">
                                      </fieldset>
                                      </section>
                                          <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                      ...
                                      <fieldset class="Employee-code">
                                        ...
                                        <input type="email" class="form-control"  id="txtDescription" placeholder="Enter Remarks">
                                      </fieldset>
                                      </section>
                                            </div>
    ...
    <script src="pagescripts/ClientDetails.js"></script>
