<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="visarequest.aspx.cs" Inherits="TimeSheet.visarequest" %>
...
<head>
    ...
    <title>Techvantage | Visa Request</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                            ...
                                            <h2 align="center">VISA REQUEST</h2>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-6">
                                                ...
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Travel Planned Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <div class='input-group date' id='Div1'>
                                                        <input type='text' class="form-control" id="txtTrvlDate"  />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">VISA Type</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <select class="selectpicker" id="ddlVisaType" name="dropdown">
                                                       
                                                        <option>Service VISA</option>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <input type="email" class="form-control" id="txtReason" style="height: 50px;">
                                                </fieldset>
                                            </section>
    ...
    <script src="pagescripts/visarequest.js"></script>
