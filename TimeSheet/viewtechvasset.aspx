<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewtechvasset.aspx.cs" Inherits="TimeSheet.viewtechvasset" %>
...
<head>
    ...
    <title>Techvantage | Assets</title>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                      ...
                                      <hr /> 
                                    <button type="button" class="btn btn-danger bt.n-lg" style="margin-top: 5px; margin-bottom:14px;margin-left:460px;font-size:10px;" id="btnCommonAssets">CLICK TO VIEW COMMON ASSETS</button>

                                    <div id="tblAssets" style="margin-top:-32px;">
                                    </div>
    ...
    <script src="pagescripts/viewtechvasset.js"></script>
