<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="employmentcert.aspx.cs" Inherits="TimeSheet.employmentcert" %>
...
<head>
    ...
    <title>Techvantage | Employment Certificate </title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                        ...
                                        <br />
                                        <h2 align="center">EMPLOYMENT CERTIFICATE</h2>
                                       ...
                                       <br />
                                                        ...
                                                        <button type="button" class="btn btn-default b.tn-lg"  style="padding-left:16px;margin-left:33px;" id="getCert">Click To Generate Employment Certificate</button>&nbsp;<br /><label id="lblWait" style="padding-left:136px;">Please Wait...</label>
                                                   
                                                   
                                               <span class="input">
                                                   
                                                    <button class="btn btn-danger" style="margin-left:110px;margin-top:10px;" type="button" id="btnDownLoad">DOWNLOAD <span class="glyphicon glyphicon-save"></span></button>
                                                </span>
    ...
    <script src="pagescripts/employmentcert.js"></script>
