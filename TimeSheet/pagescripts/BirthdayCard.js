(function ($) {
    ...
    var xv = 0;
    var snowflakes = ["Happy Birthday", "\u2746", "✯", "❤", "&#x1f49d", "❤HAPPY❤", "❤BIRTHDAY❤"];
    var prevTime;
    var absMax = 100;
    var flakeCount = 0;
    ...
    function Loadvalues() {
        ...
        debugger
        var SpParams = {};
        SpParams.strProc = "EmployeeBirthday";
            ...
            success: function (response) {
                ...
                if (response.details != null) {
                    for (var j = 0; j < response.details.length; j++) {
                        //emp = emp + response.details[j].EmpName;
                        //$('#empNames').text(emp).toString();
                        var html = "<tr><td>" + response.details[j].EmpName + "</td></tr>";
                        $("#tblempLists").append(html);
