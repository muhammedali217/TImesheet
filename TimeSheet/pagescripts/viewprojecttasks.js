$(document).ready(function () {
    ...
    if (Localvaluee == null) {
        ...
        if (Localvalue == "Start") {
            ...
            $('#tblProjectTasks').html('<table cellpadding="0" class="table v-middle"  cellspacing="0" border="0" class="display" id="tableProjectTasks"></table>');
        ...
        function Loadvalues() {
            var SpParams = {};
            SpParams.strProc = "ProjectsSubTasksView";
                ...
                success: function (response) {
                    if (response.details != null) {
                        ...
                        for (var j = 0; j < response.details.length; j++) {
                            ...
                            jQuery("#tableProjectTasks").dataTable().fnAddData([(response.details[j].Projects_ID).toString(), (response.details[j].Projects_Name).toString(), (response.details[j].SubTasks_WBS)]);
        ...
        $("#btnAssignEmployees").click(function () {
            window.location = "AssignProject.aspx";
        });
    }
});
