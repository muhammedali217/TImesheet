    ...
    if (Localvaluee == null) {
       ...
       /* $('#lblMONDAY').text('hi');*/
        ...
        function LoadProjectAssignedTask(projectId, EmployeeId) {
            ...
            var div2 = "";
            var totdiv = "";
            div0 = "<div id = 'center'><table width='85%' align='center' border='2' id='timval' ><tr style = 'height: 50px;' id='first'><td style='text-align:center; color: black;'>Task<br /><label id='lblTask'></label></td><td style='text-align:center; color: black;'><br /></td> <td id='tdmhead' style='text-align:center; color: black;'>MONDAY<br /> <label id='lblMONDAY'></label><br /><label id='MondayAbsent'>ABSENT</label></td><td id='tdthead' style='text-align:center; color: black;'>TUESDAY<br /><label id='lblTUESDAY'>dsfdsf</label><br /><label id='TuesdayAbsent'>ABSENT</label></td><td  id='tdwhead' style='text-align:center; color: black;'>WEDNESDAY<br /><label id='lblWEDNESDAY'></label><br /><label id='WednesdayAbsent'>ABSENT</label></td><td  id='tdthhead' style='text-align:center; color: black;'>THURSDAY<br /><label id='lblTHURSDAY'></label><br /><label id='ThursdayAbsent'>ABSENT</label></td><td  id='tdfhead' style='text-align:center; color: black;'>FRIDAY<br /><label id='lblFRIDAY'></label><br /><label id='Fridayabsent'>ABSENT</label></td> <td  id='tdshead' style='text-align:center; color: black;'>SATURDAY<br /><label id='lblSATURDAY'></label><br /><label id='saturdayAbsent'>ABSENT</label></td><td  id='tdsuhead' style='text-align:center; color: black;'>SUNDAY<br /><label id='lblSUNDAY'></label><br /><label id='SundayAbsent'>ABSENT</label></td><td  style='text-align:center; color: black;'>Total<br /><label id='lblHtotal'></label></td><td  style='text-align:center; color: black;'>Remarks<br /><label id='lblRemarks'></label></td></tr >";
            //alert(div0);
            div2 = " </table></div>";
            ...
            $.ajax({
                ...
                success: function (response) {
                    for (var j = 0; j < response.length; j++) {
                        ...
                        div = "<tr style='height: 50px;' id=tra" + j + "><td rowspan='2'><label class='myLabel1' id=" + (response[j].ValueMember) + " Text='" + (response[j].ValueMember) + "'>" + (response[j].DisplayMember) + "</label></td> <td style='text-align:center; color: black;'><label class='myLabel' id='ActualHead" + j + "'>Actual Hour</label><br /></td><td><input type='number' step='0.5' id=firstday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "Moday'  onchange='Hsum(\"a\"," + j + ",HTotal" + j + ");Htxtsum(\"f\",MonvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=secondday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "Tuday' onchange='Hsum(\"a\"," + j + ",HTotal" + j + ");Htxtsum(\"s\",TuevTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=thirdday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "weday' onchange='Hsum(\"a\"," + j + ",HTotal" + j + ");Htxtsum(\"t\",WedTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=fourthday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "Thday' onchange='Hsum(\"a\"," + j + ",HTotal" + j + ");Htxtsum(\"f\",ThuvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=fifthday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "Frday' onchange='Hsum(\"a\"," + j + ",HTotal" + j + ");Htxtsum(\"fi\",FrivTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td> <td><input type='number' step='0.5' id=sixthday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "Saday' onchange='Hsum(\"a\"," + j + ",HTotal" + j + ");Htxtsum(\"si\",SatvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=seventhday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "Suday' onchange='Hsum(\"a\"," + j + ",HTotal" + j + ");Htxtsum(\"se\",SunvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=HTotal" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "HTotal'  value=0 placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><textarea  id=aremarks" + j + " class='remarks aremarks' name='" + (response[j].DisplayMember) + "remarks' style='height:26px;width:152px;margin-left:15px;margin-right:15px;margin-bottom:-6.3px;'></textarea></td></tr><tr style='height: 50px;' id=trb" + j + "><td style='text-align:center; color: black;'><label class='myLabel' id='reqNor1' >Billable Hour</label><br /></td><td><input type='number' step='0.5' id=firstbday" + j + " class='FirstDay' '" + (response[j].DisplayMember) + "MoBday' onchange='Hsum(\"b\"," + j + ",HTotalB" + j + ");Htxtsum(\"f\",MonvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=secondbday" + j + " class='FirstDay' '" + (response[j].DisplayMember) + "TuBday' onchange='Hsum(\"b\"," + j + ",HTotalB" + j + ");Htxtsum(\"s\",TuevTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=thiredbday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "weBday' onchange='Hsum(\"b\"," + j + ",HTotalB" + j + ");Htxtsum(\"t\",WedTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=fourthbday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "ThBday' onchange='Hsum(\"b\"," + j + ",HTotalB" + j + ");Htxtsum(\"f\",ThuvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=fifthbday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "FrBday' onchange='Hsum(\"b\"," + j + ",HTotalB" + j + ");Htxtsum(\"fi\",FrivTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number' step='0.5' id=sixthbday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "SaBday' onchange='Hsum(\"b\"," + j + ",HTotalB" + j + ");Htxtsum(\"si\",SatvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td> <td><input type='number' step='0.5' id=seventhbday" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "SuBday'  onchange='Hsum(\"b\"," + j + ",HTotalB" + j +");Htxtsum(\"se\",SunvTotal);' placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=HTotalB" + j + " class='FirstDay' name='" + (response[j].DisplayMember) + "Total'  value=0 placeholder='Hours'  style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td> <textarea id='bremarks" + j +" class=' remarks bremarks style='height:26px;width:152px;margin-left:15px;margin-right:15px;margin-bottom:-6.3px;'></textarea></td ></tr > ";
                        //

                        //alert(div);
                        div0 += div;
                    }
                    var dibtot = "<tr style='height: 50px;' id=trtot8><td></td><td></td><td><input type='number' id=MonvTotal class='FirstDay' name='MonvTotal' placeholder='Hours'  value=0 style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=TuevTotal class='FirstDay' name='TuevTotal'  placeholder='Hours' value=0 style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=WedTotal class='FirstDay' name='WedTotal'  placeholder='Hours' value=0 style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=ThuvTotal class='FirstDay' name='ThuvTotal'  placeholder='Hours' value=0 style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=FrivTotal class='FirstDay' name='FrivTotal'  placeholder='Hours' value=0 style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=SatvTotal class='FirstDay' name='SatvTotal'  placeholder='Hours' value=0 style='height:25px;width:52px;margin-right:45px;float:right;clear:both;'/><br/></td><td><input type='number'  id=SunvTotal class='FirstDay' name='SunvTotal'  placeholder='Hours' value=0 style='height:25px;width:52px;margin-ight:45px;float:right;clear:both;'/><br/></td><td></td><td></td></tr >";
...
function Htxtsum(totctrl, curctrl) {
