$(document).ready(function () {
    ...
    if (Localvaluee == null) {
        ...
        $('#tableContractorDetails').on('click', 'a.save', function () {
            debugger
            var nRow = $(this).parents('tr')[0];
            var aData = oTable.fnGetData(nRow);
            $.alert.open('Are you sure to delete the employee ?', { 1: 'Yes', 2: 'No' }, function (button) {
                if (button == 1) {                   
                    UpdateEmployeeStatus(aData[1]);
                }
            });
        ...
        function UpdateEmployeeStatus(EmployeeId) {
            ...
            SpParams.strProc = "DeActiviate_Employee";
