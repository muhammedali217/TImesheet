<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="raiseticket.aspx.cs" Inherits="TimeSheet.raiseticket" %>
...
<head>
    ...
    <title>Techvantage | Issue Ticket</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                            ...
                                            <br />
                                            <h2 align="center">RAISE TICKET</h2>
                                    ...
                                    <hr />
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-6">
                                                ...
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">ISSUE TYPE</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                        <select class="selectpicker" id="ddlIssueType" name="dropdown">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="form-gr.oup">
                                                    ...
                                                    <div class='input-group date' id='Div2'>
                                                        <input type='text' class="form-control" id="txtIssue" style="width: 260px;" />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">PRIORITY</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                                    <select class="selectpicker" id="ddlPriority" name="dropdown">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">TICKET NUMBER</label><font color="red" size="4px"><b> &nbsp;&nbsp; </b></font>
                                                    <input type='text' class="form-control" id="tiktNumber" style="width: 260px;" />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">ISSUE IN DETAIL</label>
                                                    <input type="email" class="form-control" id="txtDesc" style="height: 50px;">
    ...
    <script src="pagescripts/raiseticket.js"></script>
