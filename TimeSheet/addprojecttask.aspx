<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addprojecttask.aspx.cs" Inherits="TimeSheet.addprojecttask" %>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">ASSIGN PROJECT TASKS</h2>
                                    ...
                                    <div class="col-md-6 col-md-offset-2">
                                        ...
                                        <section class="col-md-6" style="margin-top: 25px; margin-bottom: 30px; margin-left: 100px;">
                                            <fieldset class="Employee-code">
                                                 <label for="exampleInputEmail1">PROEJCT</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="exampleInputEmail1">TASKS</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br /><br />
                                    <div id="tblPopulateChkBox" style="margin-bottom: 30px; margin-left: 300px;">
                                    </div>
                                    <button type="button" class="btn btn-default" style="margin-top: 25px; margin-bottom: 30px; margin-left: 400px;" id="btnAssign">Assign Task</button>
    ...
    <script src="pagescripts/addprojecttask.js"></script>
