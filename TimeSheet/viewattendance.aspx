<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewattendance.aspx.cs" Inherits="TimeSheet.viewattendance" %>
...
<head>
    ...
    <title>Techvantage | Attendance</title>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h2 align="center">EMPLOYEE  ATTENDANCE</h2>
                                     </div>
                                        <hr />
                                    <label for="exampleInputEmail1">&nbsp;Select Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                   <input type="text" id="txtDate"  style="padding-left:50px;height:30px;width:150px;"/>
    ...
    <script src="pagescripts/viewattendance.js"></script>
