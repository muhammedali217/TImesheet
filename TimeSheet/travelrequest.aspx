<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="travelrequest.aspx.cs" Inherits="TimeSheet.travelrequest" %>
...
<head>
    ...
    <title>Techvantage | Travel Request</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                            ...
                                            <br />
                                            <h2 align="center">TRAVEL REQUEST</h2>
                                            <hr/>
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-6">

                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Travel From Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <div class='input-group date' id='Div1'>
                                                        <input type='text' class="form-control" id="txttravelFrm" placeholder="Choose From Date" />
                                                        <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-calendarr"></span>
                                                        </span>
                                                    </div>
                                                </fieldset>
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Travel To Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <div class='input-group date' id='Div2'>
                                                        <input type='text' class="form-control" id="txttravelTo" />
                                                        <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-calendart"></span>
                                                        </span>
                                                    </div>
                                                </fieldset>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Travel Reason</label><br />
                                                    <input type="email" class="form-control" id="txtReason">
                                                </fieldset>
                                            </section>

                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Journey Hours(Approxi)</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <input type="number" class="form-control" id="txtJourneyHours">
                                                </fieldset>
                                            </section>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Reason in Detail</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <input type="email" class="form-control" id="txtRemarks" style="height: 70px;">
                                                </fieldset>
                                            </section>
    ...
    <script src="pagescripts/travelrequest.js"></script>
