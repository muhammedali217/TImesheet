<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewprojects.aspx.cs" Inherits="TimeSheet.viewprojects" %>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand hidden-xs navbar-brand-primary">
                        <img src="web/img/logo1.png" style="width: 90px;" /></a>
                </div>
                                ...
                                <div class="tab-pane active" id="sidebar-tabs-menu">
                                    <div>
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="EmpAdd.aspx"><i class="fa fa-user"></i><span>Add Employee</span></a>
                                            </li>
                                        </ul>
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                        ...
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="ProjectAdd.aspx"><i class="fa fa-user"></i><span>Add Project</span></a>
                                            </li>
                                        </ul>

                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="AssignProject.aspx"><i class="fa fa-user"></i><span>Assign Project</span></a>
                                            </li>
                                        </ul>
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="ViewProjects.aspx"><i class="fa fa-user"></i><span>View Projects</span></a>
                                            </li>
                                        </ul>
                                        
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="AssignSubTasks.aspx"><i class="fa fa-user"></i><span> Assign Sub Tasks</span></a>
                                            </li>     
                                        </ul>

                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="NewTask2Project.aspx"><i class="fa fa-user"></i><span>New Project Task</span></a>
                                            </li> 
                                        </ul>
                                        
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="Admin_LeaveMgt.aspx"><i class="fa fa-user"></i><span> Requested Leave</span></a>
                                            </li> 
                                        </ul>

                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="ViewTimeSheet.aspx"><i class="fa fa-user"></i><span> View TimeSheet</span></a>
                                            </li> 
                                        </ul>   
                                    </div>
                                </div>
