<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="idcardrequest.aspx.cs" Inherits="TimeSheet.idcardrequest" %>
...
<head>
    ...
    <title>Techvantage | IDCard Request</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                            ...
                                            <br />
                                            <h2 align="center">ID CARD REQUEST</h2>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Request Type</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                                    <select class="selectpicker" id="ddlType" name="dropdown">
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Reason</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <input type="email" class="form-control" id="txtReason" style="height: 80px; width: 260px;">
                                                </fieldset>
                                            </section>
    ...
    <script src="pagescripts/idcardrequest.js"></script>
