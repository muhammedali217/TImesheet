<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewrequests.aspx.cs" Inherits="TimeSheet.viewrequests" %>
...
<head>
    ...
    <title>Techvantage | Requests</title>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <hr />
                                    <div class="col-md-2">
                                            <label for="exampleInputEmail1">Request Type</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                        
                                         
                                        <select class="form-control input-alt" name="ddlRequestType" id="ddlRequestType">
                                        <option value="">Choose Request</option>
                                    </select>
                                        
                                         <label for="exampleInputEmail1">Request Status</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                        <select class="form-control input-alt" name="" id="ddlStatus" style="margin-left:0px;margin-top:-2px;">
                                        ...
                                        <option value="">Rejected</option>
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-success" type="button" id="btnSearch" style="margin-left: 18px;margin-top: 55px;"><span class="glyphicon glyphicon-search"></span></button>
                                                    <button class="btn btn-default" type="button" id="btnDownLoad" style="margin-left: 7px;margin-top: 55px;"><span class="glyphicon glyphicon-save"></span></button>
                                                </span>
    ...
    <script src="pagescripts/viewrequests.js"></script>
