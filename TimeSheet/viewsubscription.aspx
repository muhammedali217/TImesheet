<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewsubscription.aspx.cs" Inherits="TimeSheet.viewsubscription" %>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">SUBSCRIBERS LIST</h2>
                                    ...
                                    <div class="col-md-2">
                                         ...
                                         <label for="exampleInputEmail1">&nbsp Choose Website</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                        <select class="form-control input-alt" name="" id="ddlWebsite" style="margin-left:0px;margin-top:-2px;">
                                        <option value="0">Choose Website</option>
                                        <option value="1">Techvantage</option>
                                        <option value="2">Stratos</option>

                                    </select>
                                        </div>
                                    <div id="tblContractor" style="margin-top:-65px;width:1000px";>
                                    </div>
    ...
    <script src="pagescripts/viewsubscription.js"></script>
