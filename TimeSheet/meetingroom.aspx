<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="meetingroom.aspx.cs" Inherits="TimeSheet.meetingroom" %>
...
<head>
    ...
    <title>Techvantage | Meeting Room Booking</title>
...
<body id="viewEmployee">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <br />
                                            <h2 align="center">MEETING ROOM BOOKING</h2>
                                            
                                        <hr />
                                            <section class="col-md-6">

                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Meeting On</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <div class='input-group date' id='Div1'>
                                                        <input type='text' class="form-control" id="txtMeetOn" />
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Meeting For</label>
                                                    <div class='input-group date' id='Div2'>
                                                        <input type='text' class="form-control" id="txtMeetFor" style="width: 260px;" />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Meeting From</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                                    <input type='text' class="form-control" id="MeetingFrom" />
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Meeting To</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                                    <input type='text' class="form-control" id="MeetingTo" />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Participants</label> <font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <select class="js-example-basic-multiple" multiple="multiple" id="ddlParticipants" style="width: 100%"></select>   
                                                </fieldset>
                                            </section>
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <br />
                                                    <input type='text' class="form-control" id="txtMeetRemarks" style="height: 50px;">
                                                </fieldset>
                                            </section>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">&nbsp;&nbsp;Need Projector?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label> <input type="radio" name="Prjector" value="YES">YES&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Prjector" value="NO">NO
                                           <label id="lblWait" style="padding-left:40px;color:green;font-size:medium">Please Wait...</label>
    ...
    <script src="pagescripts/meetingroom.js"></script>
