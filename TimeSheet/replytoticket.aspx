<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="replytoticket.aspx.cs" Inherits="TimeSheet.replytoticket" %>
...
<head>
    ...
    <title>Techvantage | View Issues</title>
...
<body>
                                ...
                                <div class="tab-pane active" id="sidebar-tabs-menu">
                                    <div>
                                        ...
                                        <ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="viewraisedtickets.aspx"><i class="fa fa-book"></i><span>VIEW ISSUES</span></a>
                                            </li>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h2 align="center">REPLY TO REQUESTED ISSUES</h2>
                                     </div>
                                        <hr />
                                    <div class=" col-sm-6 col-sm-offset-3">
                                    <div class="form-group ">
                                      <label for="message" id="msgLabel"></label>
                                      <textarea  id="txtmessage" style="cursor:initial;height:250px;" class="form-control" rows="5"></textarea>
                                    </div>
                                        <label id="lblWait" style="color:red">Please Wait</label>
                                        <button  style="margin-bottom:20px;" type="submit" class="btn btn-danger pull-right" id="btnSend">SEND</button>
    ...
    <script src="pagescripts/replytoticket.js"></script>
