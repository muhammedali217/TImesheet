<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploadknwldgedoc.aspx.cs" Inherits="TimeSheet.uploadknwldgedoc" %>
<!DOCTYPE html>
...
<head>
    ...
    <title>Techvantage | Upload Knowledge Document</title>
...
<body>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                ...
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Session Topic</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Session Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                        ...
                                        <div style="padding: 15px;" class="col-md-6 col-md-offset-3  text-center">
                                            <section class="btn-group" style="padding-right:350px";">
    ...
    <script src="pagescripts/uploadknwldgedoc.js"></script>
