<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnableTimesheet.aspx.cs" Inherits="TimeSheet.EnableTimesheet" %>
...
<head>
    ...
    <title>Techvantage | Assign Project</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">ENABLE TIMESHEET</h2>
                                    </div>
                                    <hr />
                                    <form>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <br />
                                                    <select class="js-example-basic-multiple" multiple="multiple" id="ddlEmployee" style="width: 100%"></select>
                                                </fieldset>
                                            </section>
                                            <section class="col-md-12">
                                                   <!-- datepic01-->
                                                   <label for="exampleInputEmail1">Date From</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                                   <input class="form-control" style="width: 100%; height:38px; padding:5px;" id="txtFromDate" name="txtFromDate" placeholder="Choose First Day of Week" /> 
                                                </section>
                                        ...
                                        <div style="padding: 15px;" class="col-md-6 col-md-offset-3  text-center">
                                            <section class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-default bt.n-lg" id="btnSubmit">Enable</button>
    ...
    <script src="pagescripts/EnableTimesheet.js"></script>
