<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectAdd.aspx.cs" Inherits="TimeSheet.ProjectAdd" %>
...
<body id="viewEmployee">
                ...
                <div class="st-content-inner">
                    <div class="container-fluid">
                                    ...
                                    <form>
                                     <div class="col-md-6 col-md-offset-3" >
                                      ...
                                      <fieldset class="Employee-code">
                                        ...
                                        <input type="text" class="form-control" id="txtShortName" placeholder="">
                                      </fieldset>
                                      </section>
                                            </div>
                                        <div class="col-md-6 col-md-offset-3" >
                        ...
                        <div class="col-md-6 col-md-offset-3" >
                                     ...
                                     <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Version Control</label> <font color="red" size="4px"><b> * </b></font>
                                   ...
                                   <div class="col-md-6 col-md-offset-3" >
                                        ...
                                        <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Programming Languages</label> <font color="red" size="4px"><b> * </b></font>
                                        <input type="text" class="form-control" id="txtProgramminglanguages" placeholder="Enter Programming Languages">
                                         ...
                                         <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Packages Used</label> <font color="red" size="4px"><b> * </b></font>
                                        ...
                                        <div class="col-md-6 col-md-offset-3" >
                                         ...
                                         <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Frame Work</label> <font color="red" size="4px"><b> * </b></font>
                                        <input type="text" class="form-control" id="txtFramework" placeholder="Enter Frame Work">
                                         ...
                                         <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Hosting Server</label> <font color="red" size="4px"><b> * </b></font>
                                        ...
                                        <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Database</label> <font color="red" size="4px"><b> * </b></font>
                                        ...
                                        <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Third Party Tooles</label> <font color="red" size="4px"><b> * </b></font>
                                        <input type="text" class="form-control" id="txtThirdparty" placeholder="Enter Third Party Tooles">
                                         ...
                                         <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Security</label> <font color="red" size="4px"><b> * </b></font>
                                        <input type="text" class="form-control" id="txtSecurity" placeholder="Enter Security">
                                          ...
                                          <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Ports Used</label> <font color="red" size="4px"><b> * </b></font>
    ...
    <script src="pagescripts/ProjectAdd.js"></script>
