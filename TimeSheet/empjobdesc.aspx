<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="empjobdesc.aspx.cs" Inherits="TimeSheet.empjobdesc" %>
...
<head>
    ...
    <title>Techvantage | Job Description</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                        ...
                                        <hr />
                                       <a data-toggle="tooltip" title="download" class="span3" id="myJD">DOWNLOAD YOUR JOB DESCRIPTION </a> &nbsp;&nbsp;<button type="button" class="btn btn-default" data-dismiss="modal" id="btnRefresh">Refresh</button>
                                         <div class="col-sm-12 mt-3">
                                            <%--<label style="height:30px;width:150px;font-size:14px;color:black">Name</label><label id="lblEmpName"></label><br />
                                            <label style="height:0px;width:150px;font-size:14px;color:black">Tittle</label><label id="lblJobTitle"></label><br />
                                            <label style="height:0px;width:150px;font-size:14px;color:black">Type</label><label id="lblJobtype"></label><br />
                                            <label style="height:0px;width:150px;font-size:14px;color:black">Responsibilities</label><label id="lblJobResp"></label><br />
                                            <label style="height:0px;width:150px;font-size:14px;color:black">Duties</label><label id="lblJobDuties"></label><br />--%>
                                            <embed style="width:1000px; height:2100px;padding-left:50px;" id="filesrc">
    ...
    <script src="pagescripts/empjobdesc.js"></script>
