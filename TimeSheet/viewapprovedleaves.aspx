<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewapprovedleaves.aspx.cs" Inherits="TimeSheet.viewapprovedleaves" %>
...
<head>
    ...
    <title>Techvantage | Leave Details</title>
...
<body>
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="Admin_LeaveMgt.aspx" class="navbar-brand hidden-xs navbar-brand-primary">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <hr />
                                    <label for="exampleInputEmail1">MONTH</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                        <select class="form-control input-alt" name="ddlMonth" id="ddlMonth" style="width:15%;">
                                        <option value="">Choose Month</option>
                                    </select>
                                    <button class="btn btn-default" type="button" id="btnDownLoad" style="margin-left: 188px;margin-top: -53px;"><span class="glyphicon glyphicon-save"></span></button>
                                    <div id="tblLeaves">
                                    </div>
    ...
    <script src="pagescripts/viewapprovedleaves.js"></script>
