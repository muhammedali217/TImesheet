<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reimbursement.aspx.cs" Inherits="TimeSheet.reimbursement" %>
...
<head>
    ...
    <title>Techvantage | Reimbursement </title>
...
<body id="viewEmployee">
                                ...
                                <div class="tab-pane active" id="sidebar-tabs-menu">
                                    <div>
                                        <%--<ul class="sidebar-menu sm-icons-right sm-icons-block">
                                            <li class="active"><a href="employmentcert.aspx"><i class="fa fa-users"></i><span>Employment Certificate</span></a>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                        ...
                                        <br />
                                        <h2 align="center">REIMBURSEMENT FORM</h2>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-6">
                                                ...
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Reimbursement Used Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <div class='input-group date' id='Div1'>
                                                        <input type='text' class="form-control" id="txtPaidOn" />
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Reimbursement For</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <div class='input-group date' id='Div2'>
                                                        <input type='text' class="form-control" id="txtPaidFor" style="width: 260px;" />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Type of Payment</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <select class="selectpicker" id="ddlPaymentType" name="dropdown">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Reimbursement Amount(INR)</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <div class='input-group date' id='Div3'>
                                                        <input type='text' class="form-control" id="txtAmount" style="width: 260px;" />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <input type="email" class="form-control" id="txtRemarks" style="height: 50px;">
                                                </fieldset>
                                            </section>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    <br />
                                                    <input style="display: inline-flex; margin-right: 2px; margin-left: 2px;" type="checkbox" id="ProofSubmitted" />
                                                    Hard Copy Submitted<br />
                                                    <br />
    ...
    <script src="pagescripts/reimbursement.js"></script>
