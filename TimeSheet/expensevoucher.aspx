<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="expensevoucher.aspx.cs" Inherits="TimeSheet.expensevoucher" %>
...
<head>
    ...
    <title>Techvantage | Expense Voucher</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <form>
                                            ...
                                            <br />
                                            <h2 align="center">EXPENSE VOUCHER</h2>
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            <section class="col-md-6">
                                                ...
                                                <fieldset class="form-gr.oup">
                                                    <label for="exampleInputEmail1">Paid On</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="form-gr.oup">
                                                    ...
                                                    <div class='input-group date' id='Div2'>
                                                        <input type='text' class="form-control" id="txtPaidTo" style="width: 260px;" />
                                        ...
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <section class="col-md-6">
                                                <fieldset class="Employee-code">
                                                    <label for="exampleInputEmail1">Total Cost(INR)</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                                    <input type='text' class="form-control" id="txtTotalCost" />
    ...
    <script src="pagescripts/expensevoucher.js"></script>
