<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignProject.aspx.cs" Inherits="TimeSheet.AssignProject" %>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">ASSIGN PROJECT</h2>
                                    </div>
                                    <hr />
                                    <form>       
                                      ...
                                      <fieldset class="Employee-code project">
                                        <label for="exampleInputEmail1">Project</label> | <label for="exampleInputEmail1" id="lblshortName"></label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br /><br />
                                      ...
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Employees</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br /><br />
 ...
 <fieldset class="Employee-code">
                                      ...
                                      <div style="padding:15px;" class="col-md-6 col-md-offset-3  text-center" >
                                          <section class="btn-group">
                                              ...
                                              <button type="button" class="btn btn-default bt.n-lg" id="btnSubmit">Assign</button> 
                                              <button type="button" class="btn btn-success b.tn-lg" id="btnAssignTask">Assign Tasks</button>
    ...
    <script src="pagescripts/AssignProject.js"></script>
