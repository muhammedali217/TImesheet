<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterTimeSheet.aspx.cs" Inherits="TimeSheet.EnterTimeSheet" %>
...
<body id="viewEmployee">
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="EnterTimeSheet.aspx" class="navbar-brand hidden-xs navbar-brand-primary">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row" data-toggle="isotope">
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h2 align="center">Enter Time Sheet</h2>
                                    </div>
                                    ...
                                    <form>
                                        ...
                                        <div class="col-md-4" style="padding-left: 100px;">
                                            <fieldset class="Employee-code">
                                                ...
                                                <br />
                                                <b><strong>
                                                    <label for="exampleInputEmail1" id="lblDate"></label></b></strong><br />
                                            ...
                                            <fieldset class="Employee-code">
                                               <br />
                                                <label id="lbl1"><input style="display:inline-flex; margin-right:2px; margin-left:2px;   " type="checkbox" id="checkAll"/>Choose All</label><br /><br />
                                                <div id="div1"></div>
                                            ...
                                            <section class="col-md-12">
                                                <fieldset class="Employee-code">
                                                    ...
                                                    <textarea class="form-control" id="txtDescription" placeholder="Enter Work Status"> </textarea>
                                                </fieldset>
                                            </section>
                                        ...
                                        <div style="padding: 15px;" class="col-md-6 col-md-offset-3  text-center">
                                            <section class="btn-group pull-right">
                                                ...
                                                <button type="button" class="btn btn-warning b.tn-lg" id="btnCancel">Cancel</button>
                                                <button type="button" class="btn btn-primary bt.n-lg" id="btnSubmit">Submit</button>



                                            </section>

                                            <button type="button" class="btn btn-success bt.n-lg pull-left" id="btnViewPrevious">Previous Time Sheets</button>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center" id="tblHeading">Your Last Week Time Sheet</h2>
                                    </div>
                                    <div id="tblTimeSheet" tabindex="-1">
                                    </div>
    ...
    <script src="pagescripts/EnterTimeSheet.js"></script>
