<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetEmployeeAllocation.aspx.cs" Inherits="TimeSheet.AssetEmployeeAllocation" %>
...
<head>
    ...
    <title>Techvantage | Leave History</title>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">Asset Allocation</h2>
                                     </div>
                                     <hr />
                                    <form>
                                     <div class="col-md-6 col-md-offset-3" >
                                      ...
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Employee</label> <font color="red" size="4px"><b> * </b></font>
                                      ...
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Asset Name</label>
                                         <select class="form-control input-alt" name="ddlAsset" id="ddlAsset">
                                        <option value="">Choose Asset</option>
                                         ...
                                         <div class="col-md-6 col-md-offset-3" >
                                          ...
                                          <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Remarks</label><font color="red" size="4px"><b> * </b></font>
                                         <input type="text" class="form-control" id="txtRemarks" placeholder="Remarks"/>
                                          ...
                                          <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Location</label><font color="red" size="4px"><b> * </b></font>
                                      ...
                                      <div style="padding:15px;" class="col-md-6 col-md-offset-3  text-center" >
                                         ...
                                         <button type="button" class="btn btn-default bt.n-lg" id="btnDeallocate">Deallocate</button>
                                               <button type="button" class="btn btn-danger b.tn-lg" id="btnCancel">Cancel</button> 
                                              <button type="button" class="btn btn-default bt.n-lg" id="btnAllocate">Allocate</button> 
    ...
    <script src="pagescripts/AssetEmployeeAllocation.js"></script>
