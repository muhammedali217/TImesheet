<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignSubTasks.aspx.cs" Inherits="TimeSheet.AssignSubTasks" %>
<!DOCTYPE html>
...
<head>
    ...
    <title>Techvantage | Subtasks</title>
...
<body id="viewEmployee">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                       ...
                       <li class="dropdown notifications hidden-xs hidden-sm">
                        ...
                        <li class="dropdown user">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="admin/images/administrator1.png" class="img-circle" /> Admin<span class="caret"></span>
                            </a>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center">ASSIGN TASKS TO EMPLOYEE</h2>
                                    </div>
                                    <hr />
                                    <form>
                                      ...
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Projects</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                      ...
                                      <fieldset class="Employee-code">
                                        ...
                                        <div class="col-md-6 col-md-offset-3" >
                                            <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Assign Tasks</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                          
                                        <select class="js-example-basic-multiple" multiple="multiple" id="ddlSubTasks" style="width: 100%"></select>      
                                      </fieldset>
                                      </section>
                                              <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">Approximate Hours</label><br />
                                        <input type="email" class="form-control" style="width: 100%; height:38px; padding:5px;" id="txtHours"></input>      
                                      </fieldset>
                                      </section>
                                        </div>
                                          ...
                                          <div class="col-md-6 col-md-offset-3">
                                               <section class="col-md-6">
                                                   <!-- datepic01-->
                                                   <label for="exampleInputEmail1">From Date</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                                   <input type="email" class="form-control" style="width: 100%; height:38px; padding:5px;" id="txtTasksFrom" name="txtTasksFrom" placeholder="Choose Start Date"></input>      
                                              ...
                                              <section class="col-md-6">
                                                  ...
                                                  <input type="email" class="form-control" style="width: 100%; height:38px; padding:5px;" id="txtTasksTo" name="txtTasksTo" placeholder="Choose End Date"></input>      
                                      ...
                                      <div style="padding:15px;" class="col-md-6 col-md-offset-3  text-center" >
                                          <section class="btn-group">
                                               ...
                                               <button type="button" class="btn btn-default bt.n-lg" id="btnAssign">Assign</button>
    ...
    <script src="pagescripts/AssignSubTasks.js"></script>
