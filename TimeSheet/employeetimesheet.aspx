<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="employeetimesheet.aspx.cs" Inherits="TimeSheet.employeetimesheet" %>
...
<body>
                        ...
                        <div class="row" data-toggle="isotope">
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <hr />
                                    <label for="exampleInputEmail1">Choose Date</label><font color="red" size="4px"><b> &nbsp;* </b></font>&nbsp;&nbsp;&nbsp;
                                    <input type="text" id="txtDate" style="width:110px;"/><br /><br />
                                      <button type="button" class="btn btn-default bt.n-lg" style="margin-top: -51px; margin-bottom:30px;margin-left:456px; font-size:10px;background-color:#26a69a;border-color:#26a69a;" id="btnthisWeek">CLICK TO VIEW THIS WEEK TIMESHEET</button>
                                <div id="tblimeSheet">
    ...
    <script src="pagescripts/employeetimesheet.js"></script>
