...
<head>
    ...
    <title>Techvantage | Quarterly Leave</title>
...
<body>
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h2 align="center" style="margin-left: -65px;">UPDATE QUARTERLY LEAVE</h2>
                                      ...
                                      <fieldset class="Employee-code">
                                       ...
                                       <select class="js-example-basic-multiple" multiple="multiple" id="ddlEmployee" style="width: 75%"></select>                                        
                                        ...
                                        <div class="col-md-6 col-md-offset-4" >
                                          ...
                                          <section class="col-md-6">
                                      <fieldset class="Employee-code">
                                        <label for="exampleInputEmail1">No of Leaves</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font><br />
                                        <input type="text" class="form-control" id="txtPL"  style="width: 80px;"/>
                                      </fieldset>
                                      </section>
    ...
    <script src="pagescripts/leaveupdate.js"></script>
