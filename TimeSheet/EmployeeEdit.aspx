<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="EmployeeEdit.aspx.cs" Inherits="TimeSheet.EmployeeEdit" %>
...
<head>
    ...
    <title>Techvantage | Employee Edit</title>    
                        ...
                        <div class="row" data-toggle="isotope">
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                             ...
                             <div class="tab" align="center" id="tab1"> <h4 align="center">Official Details</h4>
                                 <select  name="ddlEmployee" id="ddlEmployee">
                          ...
                          <div class="tab" align="center" id="tab3"><h4 align="center">Contact Details</h4>
                            ...
                            <p><input placeholder="Contact Number" id="txtcon_num" name="nn"></p>
...
<script src="http://formvalidation.io/vendor/formvalidation/js/framework/bootstrap.min.js"></script>--%>
   ...
   <%--<script src= "https://cdn.jsdelivr.net/jquery/1.12.4/jquery.min.js"></script>
    ...
    <script src="pagescripts/EmployeeEdit.js"></script>
