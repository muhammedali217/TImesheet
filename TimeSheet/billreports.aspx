<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="billreports.aspx.cs" Inherits="TimeSheet.billreports" %>
...
<head>
    ...
    <title>Techvantage | Bills Details</title>
...
<body>
                        ...
                        <div class="row" data-toggle="isotope">
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                        ...
                                        <h2 align="center" style="margin-top: -10px;">BILLS REPORTS</h2>
                                   
                                </div>
                                <!-- EndPanel-->

                                <div class="panel panel-default col-sm-12">
                                    <div class="panel-body bill-report">
                                        <form class="form-inline">
                                            <div class="styled-select black rounded" style="margin-top: 5px; margin-bottom: 20px; margin-left: 4px;">

                                                <select id="ddlReportType" name="dropdown">
                                                    <option value="0">Select Report Type</option>
                                                    <option value="1">Report By Bill Dates</option>
                                                    <option value="2">Report By Due Dates</option>
                                                    <option value="3">Report By Status</option>
                                                    <option value="4">Report By Invoice Company</option>
                                                    <option value="5">Report By Service Tax</option>
                                                    <option value="6">Report By TDS</option>
                                                    <option value="7">Report By Swach Bhart Cess</option>

                                                </select>
                                            </div>
                                            <br />
                                            <div class='input-group' id='invoiceCompany'>
                                                    <select class="form-control input-alt" name="ddlinvoiceCompany" id="ddlinvoiceCompany" style="margin-left:11px;margin-top:-40px">
                                                        <option value="">Choose Invoice Company</option>
                                                    </select>
                                                </div>
                                            <div class='input-group ' id='Status'>
                                                    <select class="form-control input-alt" name="ddStatus" id="ddlStatus" style="margin-left:11px;margin-top:-40px;width: 208px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class='input-group' id='datetimepicker1' style="margin-left: 4px;margin-top:-50px">
                                                    <input type='text' class="form-control" id="FromDate" placeholder="From Date" />

                                                </div>
                                            </div>
                                            <div class="input-group" style="margin-left: 4px;margin-top:-50px">
                                                <input type="text" class="form-control" placeholder="To Date" id="ToDate">
                                                
                                                <span class="input-group-btn">
                                                    <button class="btn btn-success" type="button" id="btnSearch" style="margin-left: 14px;"><span class="glyphicon glyphicon-search"></span></button>
                                                    <button class="btn btn-default" type="button" id="btnDownLoad"><span class="glyphicon glyphicon-save"></span></button>
                                                </span>
                                ...
                                <div class="panel panel-default col-sm-6">
                                           <div class="panel-body  bill-report">
                                            <form class="form-inline">
                                              ...
                                              <div class="input-group">
                                                  <input type="text" class="form-control" placeholder="To Date" id="Text2">
                                                  <span class="input-group-btn">
                                ...
                                <div id="tblBills" style="margin-top:40px;">
                                </div>
    ...
    <script src="pagescripts/billreports.js"></script>
