<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="knwldgecenter.aspx.cs" Inherits="TimeSheet.knwldgecenter" %>
...
<head>
    ...
    <title>Techvantage | Knowledge Center</title>
...
<body>
                        ...
                        <div class="row" data-toggle="isotope">
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. INTRODUCTION TO DATA SCIENCE&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  <font style="color: rgb(138, 20, 66); font-size: 12px;">Session on 18/ 05/ 2016 </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="KnowledgeCenter/intro.pptx" class="span3">DOWNLOAD</a><br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. CONDITIONAL PROBABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <font style="color: rgb(138, 20, 66); font-size: 12px;">Session on 12/ 05/ 2016 </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="KnowledgeCenter/ConditionalProbability.docx" class="span3">DOWNLOAD</a><br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4. OpenCPU MANUAL &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font style="color: rgb(138, 20, 66); font-size: 12px;">Session on 06/ 05/ 2016 </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="KnowledgeCenter/OpenCPU_Manual.docx" class="span3">DOWNLOAD</a><br />--%>
                                </div>
    ...
    <script src="pagescripts/knwldgecenter.js"></script>
