<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inv_report.aspx.cs" Inherits="TimeSheet.inv_report" %>
...
<head>
    ...
    <title>Techvantage | This Week TimeSheet</title>
...
<body id="viewEmployee">
                            ...
                            <div class="item col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h2 align="center">Utilization Report</h2>
                                    </div>
                                    <hr />
                                    <div   style="padding: 15px;" class="col-md-6 col-md-offset-3  text-center"> <label for="ddlMonth">Month</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <select class="styled-select black select" id="ddlMonth" name="dropdown" style="margin-top: -16px; margin-bottom: 5px; margin-left: -1px;width: 100px;height: 30px;">
                                        ...
                                        <label for="ddlYear">Year</label><font color="red" size="4px"><b> &nbsp;&nbsp;* </b></font>
                                                    <select class="styled-select black select" id="ddlYear" name="dropdown" style="margin-top: -16px; margin-bottom: 5px; margin-left: -1px;width: 100px;height: 30px;">
                                        ...
                                        <br />
                                         ...
                                         <section class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-default bt.n-lg" id="btnSubmit" >Process</button>
                                            
                                              <button type="button" class="btn btn-default bt.n-lg" id="btnDownload">Download</button>
                                    ...
                                    <div class="text-center week-time">
                                        <h4 style="background: #eef9cd; width: 18%; left: 50%; position: relative; padding: 10px;  font-size: 14px;letter-spacing: 0.15rem;font-weight: 600;"><span id="spnTotalHours"></span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="pagescripts/involvementreport.js"></script>
